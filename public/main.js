...
const drawFive = () => {
    axios.get('http://34.227.25.128/api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://34.227.25.128/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://34.227.25.128/api/player')
...
const getAllBots = () => {
    axios.get('http://34.227.25.128/api/robots')
        .then(({data}) => {
